...
template<typename T>
void
AssertObjectValueEqual(ObjectHolder obj, T expected, const string& msg)
{
  ostringstream one;
  obj->Print(one);
...
TestFieldAssignment()
{
  ...
  FieldAssignment assign_yz(VariableValue{ vector<string>{ "self", "y" } },
                            "z",
...
void
TestSuccessfullClassInstanceAdd()
{
  vector<Runtime::Method> methods;
...
void
TestClassInstanceAddWithoutMethod()
{
  Runtime::Class cls("BoxedValue", {}, nullptr);
