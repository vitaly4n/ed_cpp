...
TestStrings()
{
  ...
  ASSERT_EQUAL(lexer.NextToken(), Token(TokenType::String{ "long string with a double quote \" inside" }));
  ASSERT_EQUAL(lexer.NextToken(), Token(TokenType::String{ "another long string with single quote ' inside" }));
}
...
void
TestAlwaysEmitsNewlineAtTheEndOfNonemptyLine()
{
  {
